...
def main(mode):
    ...
    specific_dataset_cfg = {
        "config": {
            ...
            "other_samples":'Datasets/raw/deu_wikipedia_2007_1M-sentences-normalized.txt',
    ...
    specific_model_cfg = {
        ...
        "transfer_learning": {
            ...
            "encoder": ["encoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-READ_2016_200.pt", True, True],
            "decoder": ["decoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-READ_2016_200.pt", True, False],
        },
    }

    specific_training_cfg = {
        "output_folder": "daniel_read_strategy_C",  # folder name for checkpoint and results
        ...
        "max_char_inference": 400,
        "max_char_prediction": 400,
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='read-strat-B', params=params, dataset_name=dataset_name)
