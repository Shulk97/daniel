...
def main(mode):
    ...
    specific_training_cfg = {
        "output_folder": "daniel_rimes_strategy_B",  # folder name for checkpoint and results
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='rimes-strat-B', params=params, dataset_name=dataset_name)
