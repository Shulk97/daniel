...
def main(mode):
    ...
    specific_model_cfg = {
        ...
        "transfer_learning": {
            ...
            "encoder": ["encoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-RIMES_155.pt", True, True],
            "decoder": ["decoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-RIMES_155.pt", True, False],
        },
    }

    specific_training_cfg = {
        "output_folder": "daniel_rimes_strategy_C",  # folder name for checkpoint and results
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='rimes-strat-C', params=params, dataset_name=dataset_name)
