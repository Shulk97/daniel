...
def main(mode):
    ...
    specific_training_cfg = {
        "output_folder": "daniel_custom_dataset",  # folder name for checkpoints and results
    ...
    if params["training_params"].get("use_wandb", False):
        init_wandb(projet_name="daniel", exp_id='custom-dataset-direct-fine-tuning', params=params, dataset_name=dataset_name)
