...
def main(mode):
    ...
    specific_training_cfg = {
        "output_folder": "daniel_iam_strategy_B",  # folder name for checkpoint and results
        ...
        "max_char_inference": 250, # max number of token prediction during inference
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='iam-strat-B', params=params, dataset_name=dataset_name)
