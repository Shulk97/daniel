...
def main(mode):
    ...
    specific_training_cfg = {
        "output_folder": "daniel_iam_ner_strategy_B_rwth_split",  # folder name for checkpoint and results
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='iam-ner-rwth-split-strat-B', params=params, dataset_name=dataset_name)
