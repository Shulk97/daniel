...
def main(mode):
    ...
    specific_dataset_cfg = {
        ...
        "config": {
            ...
            "labels_name": "formatted-18-entities-daniel-charset.pkl", # was not used at the beginning because of the bug
    ...
    specific_model_cfg = {
        ...
        "transfer_learning": {
            ...
            "encoder": ["encoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-IAM_NER_185.pt", True, True],
            "decoder": ["decoder", "outputs/daniel_iam_ner_strategy_A_rwth_split/checkpoints/best-IAM_NER_185.pt", True, False],
        },
    }

    specific_training_cfg = {
        "output_folder": "daniel_iam_ner_strategy_C_rwth_split",  # folder name for checkpoint and results
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='iam-ner-rwth-split-strat-C', params=params, dataset_name=dataset_name)
