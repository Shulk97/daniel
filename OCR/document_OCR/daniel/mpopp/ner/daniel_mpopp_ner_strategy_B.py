...
def main(mode):
    ...
    specific_dataset_cfg = {
        ...
        'synth_eval_loaders': ['EXOPOPP'],
        'add_NEs_in_charset':True,
        "config": {
            "layout_tokens_mode": 'MULTI_EXOPOPP',
            "mean" : [182.72022651],
            "std" : [63.95714202],
            "labels_name": "labels-mpopp-ner.pkl",
    ...
    specific_training_cfg = {
        "output_folder": "daniel_mpopp_ner_strategy_B",  # folder name for checkpoint and results
        ...
        "focus_metric": "stricter_f1",  # Metrics to focus on to determine best epoch
        "expected_metric_value": "high",  # ["high", "low"] What is best for the focus metric value
        ...
        "eval_metrics": ["cer", "wer", 'f1','cer-ner', 'stricter_f1'],
    ...
    if params["training_params"]["use_wandb"]:
        init_wandb(projet_name="daniel", exp_id='mpopp-strat-B', params=params, dataset_name=dataset_name)
